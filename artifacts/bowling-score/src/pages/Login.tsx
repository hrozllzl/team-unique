          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="flex items-center gap-2 px-1 pt-1">
              <button
                ...
                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors cursor-pointer ${stayLoggedIn ? "bg-blue-500 border-blue-500" : "bg-white border-gray-300"}`}
