          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              {editing ? (
                ...
                <div className="flex items-center gap-2">
                  <div className="flex shrink-0 items-center gap-1 rounded-full border border-gray-100 bg-gray-50 px-1.5 py-1.5">
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${!account.birthdate.startsWith("음력") ? "bg-gray-200 text-gray-500" : "text-gray-300"}`}>양력</span>
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${account.birthdate.startsWith("음력") ? "bg-gray-200 text-gray-500" : "text-gray-300"}`}>음력</span>
                  </div>
